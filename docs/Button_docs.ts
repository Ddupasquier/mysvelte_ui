  ...
  },
  {
    ...
    examples: [
      ...
      },
      {
        ...
        props: {
          text: 'Icon',
          icon: `<svg fill="#000000" viewBox="0 0 22 22" xmlns="http://www.w3.org/2000/svg" id="memory-email"><path d="M1 5H2V4H20V5H21V18H20V19H2V18H1V5M3 17H19V9H18V10H16V11H14V12H12V13H10V12H8V11H6V10H4V9H3V17M19 6H3V7H5V8H7V9H9V10H13V9H15V8H17V7H19V6Z" /></svg>`,
        } as ButtonIconProps,
        code: [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        {
          name: 'button_size',
          description: "Sets the size of the button. Choose from 'xsmall', 'small', 'medium', 'large', or 'xlarge'. Default is 'medium'.",
          default: 'medium',
          nav: true
        },
        {
          name: 'button_background',
          description: "Lets you personalize the button's background color with any valid CSS color. Default is '#c50eff'.",
          default: '#c50eff',
          nav: true
        },
        {
          name: 'button_color',
          description: "Changes the color of the button's text. Use any valid CSS color. Default is '#fff'.",
          default: '#fff',
          nav: true
        },
        {
