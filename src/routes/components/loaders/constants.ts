...
export const loaders: LoaderDisplayData[] = [
    ...
    examples: [
      {
        ...
        code: [`<Loader size={size} color={color} />`],
      },
      {
        component: Loader,
        props: {
  ...
  },
  {
    id: 'loader-elips',
    header: 'Loader Elips',
    description: 'Similar to the default loader, but with a different animation. \nThe props available are size and color. \nThe size prop can be set to small, medium or large. The color prop can be set to any valid CSS color value. \n(default size: medium, default color: #c50eff)',
    type: 'components',
    examples: [
      {
        ...
        code: [`<Loader.Elips size={size} color={color} />`],
      },
      {
        component: Loader.Elips,
        props: {
